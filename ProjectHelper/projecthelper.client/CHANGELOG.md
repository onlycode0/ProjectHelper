...
- Create Angular project with ng: `ng new projecthelper.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`projecthelper.client.esproj`).
